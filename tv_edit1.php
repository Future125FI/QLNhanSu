...
if(isset($_POST["btnsua"])) {
    ...
    $Nguyenquan = $_POST["txtngquan"];
    $Quoctich = $_POST["txtqtich"];
    $Dantoc = $_POST["txtdantoc"];
    $Tongiao = $_POST["txttongiao"];
    $Tinhtranghonnhan = $_POST["txttthonnhan"];
    $Tinhtrangsuckhoe = $_POST["txtttsuckhoe"];

    // Thực hiện câu lệnh SQL để cập nhật thông tin vào cơ sở dữ liệu
    $update_query = "UPDATE thongtinnhanvien SET Hoten='$Hoten', Ngaysinh='$Ngaysinh', Noisinh='$Noisinh', Nguyenquan='$Nguyenquan', Quoctich='$Quoctich', Dantoc='$Dantoc', Tongiao='$Tongiao', Tinhtranghonnhan='$Tinhtranghonnhan', Tinhtrangsuckhoe='$Tinhtrangsuckhoe' WHERE MaNV='$MaNV'";
...
<form id="form1" name="form1" method="post" action="tv_edit1.php" >
