...
<style>
.color-change {
    transition: color 0.3s ease; /* Thêm hiệu ứng chuyển đổi màu trong 0.3 giây */
}

.color-change:hover {
    color: red; /* Màu sẽ thay đổi thành đỏ khi di chuột vào */
}
...
#changing-text {
    animation: colorChange 3s infinite; /* Áp dụng animation với thời gian 3 giây và lặp vô hạn */
}
...
<body>
<center><h1 id="changing-text">Thay đổi thông tin người dùng</h1></center>

<form id="form1" name="form1" method="post" action="tv_edit1thitranlongphu.php" >
  <table width="100%" border="0" height="100%">
    <tr>
    <td colspan="5"><a href="index.php" class="color-change">Quay trở lại trang chủ</a></td>
</tr>
<tr>
    <td colspan="5"><a href="tv_danhmucthitranlongphu.php?search=" class="color-change">Quay trở lại trang trước</a></td>
</tr>


    <tr>
    <td width="16%" rowspan="20">&nbsp;</td>
    <td width="9%" rowspan="20">&nbsp;</td>
