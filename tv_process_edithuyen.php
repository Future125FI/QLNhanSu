...
//kết nối tới csdl
		include("ketnoi.inc");
		$ketqua_them = mysql_query("update thongtinnhanvien set Hoten='$Hoten',Ngaysinh='$Ngaysinh',Gioitinh='$Gioitinh',Quoctich='$Quoctich',Dantoc='$Dantoc',Tongiao='$Tongiao',Quequan='$Quequan', Giaoducphothong='$Giaoducphothong',Chuyenmonnghiepvu='$Chuyenmonnghiepvu',Tuoi='$Tuoi',Lyluanchinhtri='$Lyluanchinhtri', Ngoaingu='$Ngoaingu',Nghengiepchucvu='$Nghengiepchucvu',Noicongtac='$Noicongtac', Ngayvaodang='$Ngayvaodang',Ghichu='$Ghichu', Thaotac='$Thaotac' where MaNV='$MaNV'",$link);
				if($ketqua_them)
				{
				...
				else
				{
					...
					<?php
					header("location:tv_edit1huyen.php?MaNV='$MaNV'");
				}
