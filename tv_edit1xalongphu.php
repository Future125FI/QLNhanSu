...
<form id="form1" name="form1" method="post" action="tv_edit1xalongphu.php" >
  <table width="100%" border="0" height="100%">
    <tr>
    <td colspan="5"><a href="index.php">Quay trở lại trang chủ</a></td>
</tr>
<tr>
    <td colspan="5"><a href="tv_danhmucxalongphu.php?search=">Quay trở lại trang trước</a></td>
</tr>
    <tr>
