...
// Kiểm tra xem có tham số MaNV truyền vào không
if(isset($_GET['MaNV'])) {
    $MaNV = $_GET['MaNV'];

    // Truy vấn thông tin từ bảng nhansuhuyen
    $query = "SELECT * FROM nhansuhuyen WHERE Maso = '$MaNV'";
...
if(isset($_POST['btnsua'])) {
    ...
    $update_query = "UPDATE nhansuhuyen SET Hoten='$Hoten', Ngaysinh='$Ngaysinh', Gioitinh='$Gioitinh', Quoctich='$Quoctich', Dantoc='$Dantoc', Tongiao='$Tongiao', Quequan='$Quequan', Giaoducphothong='$Giaoducphothong', Chuyenmonnghiepvu='$Chuyenmonnghiepvu', Tuoi='$Tuoi', Lyluanchinhtri='$Lyluanchinhtri', Ngoaingu='$Ngoaingu', Nghenghiepchucvu='$Nghenghiepchucvu', Noicongtac='$Noicongtac', Ngayvaodang='$Ngayvaodang', Ghichu='$Ghichu' WHERE Maso='$Maso'";
