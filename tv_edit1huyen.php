...
if(isset($_POST["btnsua"])) {
    ...
    $update_query = "UPDATE nhansuhuyen SET Hoten='$Hoten', Ngaysinh='$Ngaysinh', Gioitinh='$Gioitinh', Quoctich='$Quoctich', Dantoc='$Dantoc', Tongiao='$Tongiao', Quequan='$Quequan',  Giaoducphothong='$Giaoducphothong', Chuyenmonnghiepvu='$Chuyenmonnghiepvu', Tuoi='$Tuoi', Lyluanchinhtri='$Lyluanchinhtri', Ngoaingu='$Ngoaingu', Nghenghiepchucvu='$Nghenghiepchucvu', Noicongtac='$Noicongtac', Ngayvaodang='$Ngayvaodang', Ghichu='$Ghichu', Thaotac='$Thaotac' WHERE MaNV='$MaNV'";
...
<form id="form1" name="form1" method="post" action="tv_edit1huyen.php" >
  <table width="100%" border="0" height="100%">
    ...
    <td width="23%"><div align="left">Mã NV</div></td>
    <td width="33%"><label>
